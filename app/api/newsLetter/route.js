    ...
    try {
      ...
      if (apiKey) {
        await fetch('https://api.brevo.com/v3/smtp/email', {
          ...
          body: JSON.stringify({
            sender: { name: 'Hotel Shivan Residence', email: 'digitalservicesinrishikesh@gmail.com' },
            to: [{ email }],
            ...
            <div style="font-family: 'Courier New', Courier, monospace; background: #fcf7f1; margin:0; padding:0;">
              ...
              <div style="background:#c7eaff;padding:24px 0 12px 0;text-align:center;border-bottom:2px solid #222;">
                <h1 style="margin:0;font-size:2.2rem;font-weight:900;letter-spacing:1px;">
                  <span style="border-bottom:4px solid #222;">Hotel Shivan Residence</span>
                </h1>
                <div style="font-size:1.1rem;font-weight:500;margin-top:6px;">
                  Hotel Shivan Residence is an complete outdoor shop.
                </div>
              </div>
              <!-- Main Content -->
              <div style="max-width:600px;margin:32px auto 0 auto;background:#fff;padding:32px 24px 24px 24px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
                ...
                <p style="font-size:1.05rem;">
                  We&rsquo;re excited to have you as part of our Hotel Shivan Residence family. You&rsquo;ll now be the first to know about our best trending deals, exclusive offers, and new arrivals delivered straight to your inbox from time to time.
                </p>
                <p style="font-size:1.05rem;">
                 Hotel Shivan Residence is an complete outdoor shop.Adventure Sports Equipment Store 👉 Water Sports Equipment 👉 Safety & Rescue Equipment 👉 Clothing & Footwear 👉 Camping & Outdoor 👉 Expedition GearRaft-Inflatables
                </p>
                <p style="font-size:1.05rem;margin-top:28px;margin-bottom:0;">
                  Happy Shopping!<br>
                  <strong>Team Hotel Shivan Residence</strong>
                </p>
                <div style="margin:28px 0 18px 0;">
                  <img src="https://www.digitalservicesinrishikesh@gmail.com/_next/image?url=%2Flogo.png&w=256&q=75" alt="Adventure Axis Logo" style="height:64px;margin-bottom:8px;" />
                  <div style="font-size:1.1rem;font-weight:bold;margin-bottom:2px;">
                    Web: <a href="https://www.digitalservicesinrishikesh@gmail.com" style="color:#0056b3;text-decoration:underline;">www.digitalservicesinrishikesh@gmail.com</a>
                  </div>
              ...
              <div style="background:#ededed;padding:20px 0 16px 0;margin-top:32px;font-size:0.93rem;color:#222;border-top:2px solid #222;">
                <div style="max-width:700px;margin:0 auto;padding:0 16px;">
                  ...
                  <br><br>
                  If you would prefer not receiving our emails, please click here to <a href="https://www.digitalservicesinrishikesh@gmail.com/unsubscribe" style="color:#0056b3;">unsubscribe</a>.<br>
                  <span style="color:#888;">© ${new Date().getFullYear()} Hotel Shivan Residence. All rights reserved</span>
                </div>
              </div>
            </div>
          `
