...
const CreateManagementInvoiceSchema = new Schema({ 
...
export default models.CreateManagementInvoice || model("CreateManagementInvoice", CreateManagementInvoiceSchema);